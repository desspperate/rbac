...
class UserRolesUpdate(BaseModel):
    set: Sequence[UserRoleUpdate] = Field(default_factory=list[UserRoleUpdate])
...
class UserPermissionsUpdate(BaseModel):
    set: Sequence[UserPermissionUpdate] = Field(default_factory=list[UserPermissionUpdate])
    remove: Sequence[int] = Field(default_factory=list[int])
